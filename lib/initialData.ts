...
export const INITIAL_USERS: User[] = [
  { id: 'usr-1', name: 'Michelle, S.H.', email: 'michelle@waktunyalegal.id', role: 'super_admin', department: 'Founder & Executive Management', phone: '0812-1000-0001' },
  { id: 'usr-2', name: 'Maya Putri, S.H.', email: 'maya.putri@waktunyalegal.id', role: 'admin', department: 'Legal Operations', phone: '0812-1000-0002' },
  { id: 'usr-3', name: 'Budi Santoso, S.H.', email: 'budi.santoso@waktunyalegal.id', role: 'technical', department: 'Corporate Legal', phone: '0812-1000-0003' },
  { id: 'usr-4', name: 'Siti Rahma, S.H.', email: 'siti.rahma@waktunyalegal.id', role: 'technical', department: 'Licensing & Permits', phone: '0812-1000-0004' },
  { id: 'usr-5', name: 'Eko Prasetyo', email: 'eko.prasetyo@waktunyalegal.id', role: 'admin', department: 'Administration', phone: '0812-1000-0005' },
  { id: 'usr-6', name: 'Agus Hermawan, A.Md.', email: 'agus.hermawan@waktunyalegal.id', role: 'finance', department: 'Finance & Billing', phone: '0812-1000-0006' },
...
export const INITIAL_TASKS: Task[] = [
  {
    id: 'tsk-01',
    workOrderId: 'wo-101',
    title: 'Verifikasi Kelengkapan KTP, NPWP & Bukti Domisili Kantor',
    description: 'Validasi NIK Dukcapil, status KSWP NPWP para pendiri, dan legalitas sewa ruang kantor.',
    assigneeId: 'usr-4',
    assigneeName: 'Siti Rahmawati (Tim Teknis)',
    priority: 'High',
    deadline: '2026-09-12',
    status: 'Completed',
    attachmentsCount: 4,
  ...
  },
  {
    id: 'tsk-02',
    workOrderId: 'wo-101',
    title: 'Pemeriksaan & Reservasi Nama PT di Ditjen AHU Kemenkumham',
    description: 'Pengecekan ketersediaan 3 opsi nama dan pembayaran PNBP voucher pemesanan nama pada SABH Online.',
    assigneeId: 'usr-3',
    assigneeName: 'Budi Santoso, S.H. (Notaris)',
    priority: 'High',
    deadline: '2026-09-14',
    status: 'Completed',
    attachmentsCount: 1,
  ...
  },
  {
    id: 'tsk-03',
    workOrderId: 'wo-101',
    title: 'Penyusunan Draf Anggaran Dasar & Minuta Akta',
    description: 'Perumusan pasal modal dasar, susunan direksi/komisaris, dan pencocokan KBLI 5 digit.',
    assigneeId: 'usr-3',
    assigneeName: 'Budi Santoso, S.H. (Notaris)',
    priority: 'High',
    deadline: '2026-09-15',
  ...
  },
  {
    id: 'tsk-04',
    workOrderId: 'wo-101',
    title: 'Penandatanganan Minuta Akta Pendirian',
    description: 'Penandatanganan akta otentik oleh penghadap/kuasa pendiri di hadapan notaris.',
    assigneeId: 'usr-3',
    assigneeName: 'Budi Santoso, S.H. (Notaris)',
    priority: 'High',
    deadline: '2026-09-17',
  ...
  },
  {
    id: 'tsk-05',
    workOrderId: 'wo-101',
    title: 'Pengajuan Pengesahan Badan Hukum di AHU Online',
    description: 'Pendaftaran akta resmi ke Ditjen AHU untuk penerbitan SK Menteri Hukum dan HAM.',
    assigneeId: 'usr-3',
    assigneeName: 'Budi Santoso, S.H. (Notaris)',
    priority: 'High',
    deadline: '2026-09-18',
  ...
  },
  {
    id: 'tsk-06',
    workOrderId: 'wo-101',
    title: 'Konfirmasi & Penerbitan NPWP Badan Usaha',
    description: 'Penerbitan otomatis NPWP Badan dan SKT dari Ditjen Pajak pasca-SK Kemenkumham terbit.',
    assigneeId: 'usr-4',
    assigneeName: 'Siti Rahmawati (Tim Teknis)',
    priority: 'Medium',
    deadline: '2026-09-21',
  ...
  },
  {
    id: 'tsk-07',
    workOrderId: 'wo-101',
    title: 'Registrasi Hak Akses & Pendaftaran NIB di OSS RBA',
    description: 'Input KBLI 62019 (Aktivitas Pemrograman Komputer Lainnya) & validasi tata ruang PKKPR.',
    assigneeId: 'usr-4',
    assigneeName: 'Siti Rahmawati (Tim Teknis)',
    priority: 'Urgent',
    deadline: '2026-09-24',
  ...
  },
  {
    id: 'tsk-08',
    workOrderId: 'wo-101',
    title: 'Verifikasi Akhir & Pengemasan Dokumen Legalitas',
    description: 'Pemeriksaan kesesuaian Akta, SK, NPWP, NIB, dan pembuatan bundel digital siap unduh.',
    assigneeId: 'usr-2',
    assigneeName: 'Admin Koordinator',
    priority: 'Medium',
    deadline: '2026-09-25',
    status: 'To Do',
    attachmentsCount: 0,
